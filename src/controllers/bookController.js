  ...
  try {
    ...
    if (Object.keys(data).length == 0) {
      return res
        ...
        .send({
          status: false,
          msg: "please enter require data to create Book",
        });
    }
    ...
    if (!title) {
      return res
        .status(400)
        .send({ status: false, msg: "please enter Book title" });
    }
    ...
    if (!/^[a-zA-Z \s]+$/.test(title)) {
      return res
        .status(400)
        .send({ status: false, msg: "Please Enter Only Alphabets in title" });
    }
    if (!excerpt) {
      return res
        .status(400)
    ...
    if (!/^[a-zA-Z \s]+$/.test(excerpt)) {
      return res
        .status(400)
        .send({ status: false, msg: "Please Enter Only Alphabets in excerpt" });
    }
    if (!userId) {
      return res
        .status(400)
    ...
    if (!/^\+?([1-9]{3})\)?[-. ]?([0-9]{10})$/.test(ISBN)) {
      return res
        ...
        .send({
          status: false,
          message: "Please provide a valid ISBN(ISBN should be 13 digit)",
        });
    }
    ...
    if (!category) {
      return res
        .status(400)
        .send({ status: false, msg: "please enter Book category" });
    }
    if (!/^[a-zA-Z \s]+$/.test(category)) {
      return res
        .status(400)
        .send({ status: false, msg: "Please Enter Only Alphabets in tittle" });
    }

    if (!subcategory) {
      return res
        .status(400)
        .send({ status: false, msg: "please ented subcategory" });
    }
    if (!/^[a-zA-Z \s]+$/.test(subcategory)) {
      return res
        ...
        .send({
          status: false,
          msg: "Please Enter Only Alphabets in subcategory",
        });
    }
    //Creating Data Here
  ...
  try {
    ...
    if (userId) {
      ...
      if (!findById) {
        res
          .status(404)
          .send({ status: false, message: "No user with this id exist" });
      }
    }
    if (category) {
      ...
      if (!findByCategory) {
        res
          ...
          .send({
            status: false,
            message: "No books with this category exist",
          });
      }
    }
    if (subcategory) {
      let findBySubcategory = await userModel.findOne({
      ...
      if (!findBySubcategory) {
        res
          ...
          .send({
            status: false,
            message: "No books with this Subcategory exist",
          });
      }
    }
    ...
    if (books.length == 0) {
      return res
        ...
        .send({
          status: false,
          message: "No books found with the given query",
        });
    }
...
const getBookById = async (req, res) => {
  try {
    ...
    if (!id) {
      res
        .status(400)
        .send({ status: false, message: "Please enter a book ID." });
    }
    ...
    let bookData = await bookModel
      .findById(id)
      .select({ ISBN: 0, deletedAt: 0, _v: 0 });
    if (!bookData) {
      res
        .status(404)
        .send({ status: false, message: "No Book exists with that id" });
    }
  ...
  try {
    ...
    if (Object.keys(data).length == 0) {
      return res
        ...
        .send({
          status: false,
          msg: "please provide details what you want to update",
        });
    }
    if (!bookId) {
      return res
        .status(400)
        .send({ status: false, msg: "please enter bookId in params" });
    }
    ...
    if (!title) {
      return res
        .status(400)
        .send({ status: false, msg: " title is required to update" });
    }
    if (!/^[a-zA-Z \s]+$/.test(title)) {
      return res
        .status(400)
    ...
    if (titleAlreadyUsed) {
      return res
        ...
        .send({
          status: false,
          msg: "title Already exist please provide another title",
        });
    }
    if (!ISBN) {
      return res
        .status(400)
        .send({ status: false, msg: " ISBN is required to update" });
    }
    ...
    if (ISBNAlreadyUsed) {
      return res
        ...
        .send({
          status: false,
          msg: "ISBN Already exist please provide another ISBN",
        });
    }
    if (!excerpt) {
      return res
        .status(400)
        .send({ status: false, msg: "excerpt is required to update" });
    }
    ...
    if (!releasedAt) {
      return res
        .status(400)
        .send({ status: false, msg: "releaseAt is required to update" });
    }
    if (releasedAt) {
      ...
      res
        ...
        .send({
          status: true,
          msg: "successfully update book details",
